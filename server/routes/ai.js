...
- If the user asks to create a task, break down a goal, or plan their day, suggest structured actions in JSON format inside your response if appropriate.
...
Task:
Write a single, compelling, 2-sentence natural explanation answering "WHY NOW?" for this task. Explain why completing it right now provides maximum value.
`.trim();
...
JSON Format Only. No markdown markdown codeblocks.
`.trim();
